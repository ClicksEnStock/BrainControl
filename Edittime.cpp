...
LPWSTR BaudRateList[] = {
	0,	// reserved
	MAKEINTRESOURCE(IDS_BAUDRATE1200),	
	MAKEINTRESOURCE(IDS_BAUDRATE2400),
	MAKEINTRESOURCE(IDS_BAUDRATE4800),
	MAKEINTRESOURCE(IDS_BAUDRATE9600),
	MAKEINTRESOURCE(IDS_BAUDRATE57600),
	MAKEINTRESOURCE(IDS_BAUDRATE115200),	
	NULL
};
#else
LPCSTR BaudRateList[] = {
...
PropData Properties[] = {
	...
	PropData_ComboBox	(PROPID_COMBO_BAUDRATE,		IDS_PROP_BAUDRATE,			IDS_PROP_BAUDRATE_INFO, BaudRateList),
// Example
// -------
...
//	}
	switch (nPropID) {
	case PROPID_COMBO_BAUDRATE:
		return new CPropDWordValue(edPtr->baudRateId);
	}
...
//
	case PROPID_COMBO_BAUDRATE:
		...
		edPtr->baudRateId = ((CPropDWordValue*)pValue)->m_dwValue;
		break;
